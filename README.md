...
- **Fase 2 (C++):** Implementasi kode program dalam file `Problem1-The Last Astronaut.cpp`
...
- **Fase 2 (C++):** Implementasi kode enkripsi teks dalam file `Problem2-Alien In The Middle.cpp` dengan fungsi buatan manual.
